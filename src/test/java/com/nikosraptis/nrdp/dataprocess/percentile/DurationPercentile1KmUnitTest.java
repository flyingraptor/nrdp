...
public class DurationPercentile1KmUnitTest {
    ...
    public void testPercentiles1km95PercentAndGroupByHours() {
        ...
        /* Preparation */
        classUnderTest = new DurationPercentileService(95, GROUP_BY_MODE.HOURS); //<-HOURS
        List<Ride> rides = prepare1kmRidesWith1to5MinutesDuration();
        ...
        for(Map.Entry<String, List<Percentile>> entry: percentilesPerHours.entrySet()) {
            if(entry.getKey().equals("13:00")) {
                ...
                assertThat(entry.getValue().get(0).getLinkedBucketName(),is("1km"));
            }
    ...
    private List<Ride> prepare1kmRidesWith1to5MinutesDuration() {
        ...
        rideBuilder.addRoutePoint("38.018001", "23.730222", "1405591942"); //Thursday, July 17, 2014 1:12:22 PM
        rideBuilder.addRoutePoint("38.019398", "23.728953", "1405592024"); //Distance is 0.1910km and duration is 1m37s
        rides.add(rideBuilder.getRide());

        rideBuilder.createNewRide("2");
        rideBuilder.addRoutePoint("38.018001", "23.730222", "1405678342"); //Friday, July 18, 2014 1:12:22 PM
        rideBuilder.addRoutePoint("38.019398", "23.728953", "1405678424"); //Distance is 0.1910km and duration is 1m37s
        rides.add(rideBuilder.getRide());

        rideBuilder.createNewRide("3");
        rideBuilder.addRoutePoint("38.018001", "23.730222", "1405595542"); //Thursday, July 17, 2014 2:12:22 PM
        rideBuilder.addRoutePoint("38.019398", "23.728953", "1405595602"); //Distance is 0.1910km and duration is 1m0s
        rides.add(rideBuilder.getRide());

        rideBuilder.createNewRide("4");
        rideBuilder.addRoutePoint("38.018001", "23.730222", "1405681942"); //Thursday, July 18, 2014 2:12:22 PM
        rideBuilder.addRoutePoint("38.019398", "23.728953", "1405682002"); //Distance is 0.1910km and duration is 1m0s
        rides.add(rideBuilder.getRide());

        /* 2 Minutes Durations */
        rideBuilder.createNewRide("5");
        rideBuilder.addRoutePoint("38.018001", "23.730222", "1405591942"); //Thursday, July 17, 2014 1:12:22 PM
        rideBuilder.addRoutePoint("38.019398", "23.728953", "1405592062"); //Distance is 0.1910km and duration is 2m0s
        rides.add(rideBuilder.getRide());

        rideBuilder.createNewRide("6");
        rideBuilder.addRoutePoint("38.018001", "23.730222", "1405678342"); //Thursday, July 18, 2014 1:12:22 PM
        rideBuilder.addRoutePoint("38.019398", "23.728953", "1405678462"); //Distance is 0.1910km and duration is 2m0s
        rides.add(rideBuilder.getRide());

        rideBuilder.createNewRide("7");
        rideBuilder.addRoutePoint("38.018001", "23.730222", "1405595542"); //Thursday, July 17, 2014 2:12:22 PM
        rideBuilder.addRoutePoint("38.019398", "23.728953", "1405595662"); //Distance is 0.1910km and duration is 2m0s
        rides.add(rideBuilder.getRide());

        rideBuilder.createNewRide("8");
        rideBuilder.addRoutePoint("38.018001", "23.730222", "1405681942"); //Thursday, July 18, 2014 2:12:22 PM
        rideBuilder.addRoutePoint("38.019398", "23.728953", "1405682062"); //Distance is 0.1910km and duration is 1m0s
        rides.add(rideBuilder.getRide());

        /* 3 Minutes Durations */
        rideBuilder.createNewRide("9");
        rideBuilder.addRoutePoint("38.018001", "23.730222", "1405591942"); //Thursday, July 17, 2014 1:12:22 PM
        rideBuilder.addRoutePoint("38.019398", "23.728953", "1405592122"); //Distance is 0.1910km and duration is 3m0s
        rides.add(rideBuilder.getRide());

        rideBuilder.createNewRide("10");
        rideBuilder.addRoutePoint("38.018001", "23.730222", "1405678342"); //Thursday, July 18, 2014 1:12:22 PM
        rideBuilder.addRoutePoint("38.019398", "23.728953", "1405678522"); //Distance is 0.1910km and duration is 3m0s
        rides.add(rideBuilder.getRide());

        rideBuilder.createNewRide("11");
        rideBuilder.addRoutePoint("38.018001", "23.730222", "1405595542"); //Thursday, July 17, 2014 2:12:22 PM
        rideBuilder.addRoutePoint("38.019398", "23.728953", "1405595722"); //Distance is 0.1910km and duration is 3m0s
        rides.add(rideBuilder.getRide());

        rideBuilder.createNewRide("12");
        rideBuilder.addRoutePoint("38.018001", "23.730222", "1405681942"); //Thursday, July 18, 2014 2:12:22 PM
        rideBuilder.addRoutePoint("38.019398", "23.728953", "1405682122"); //Distance is 0.1910km and duration is 3m0s
        rides.add(rideBuilder.getRide());

        /* 4 Minutes Durations */
        rideBuilder.createNewRide("13");
        rideBuilder.addRoutePoint("38.018001", "23.730222", "1405591942"); //Thursday, July 17, 2014 1:12:22 PM
        rideBuilder.addRoutePoint("38.019398", "23.728953", "1405592182"); //Distance is 0.1910km and duration is 4m0s
        rides.add(rideBuilder.getRide());

        rideBuilder.createNewRide("14");
        rideBuilder.addRoutePoint("38.018001", "23.730222", "1405678342"); //Thursday, July 18, 2014 1:12:22 PM
        rideBuilder.addRoutePoint("38.019398", "23.728953", "1405678582"); //Distance is 0.1910km and duration is 4m0s
        rides.add(rideBuilder.getRide());

        rideBuilder.createNewRide("15");
        rideBuilder.addRoutePoint("38.018001", "23.730222", "1405595542"); //Thursday, July 17, 2014 2:12:22 PM
        rideBuilder.addRoutePoint("38.019398", "23.728953", "1405595782"); //Distance is 0.1910km and duration is 3m0s
        rides.add(rideBuilder.getRide());

        rideBuilder.createNewRide("16");
        rideBuilder.addRoutePoint("38.018001", "23.730222", "1405681942"); //Thursday, July 18, 2014 2:12:22 PM
        rideBuilder.addRoutePoint("38.019398", "23.728953", "1405682182"); //Distance is 0.1910km and duration is 3m0s
        rides.add(rideBuilder.getRide());

        /* 5 Minutes Durations */
        rideBuilder.createNewRide("17");
        rideBuilder.addRoutePoint("38.018001", "23.730222", "1405591942"); //Thursday, July 17, 2014 1:12:22 PM
        rideBuilder.addRoutePoint("38.019398", "23.728953", "1405592242"); //Distance is 0.1910km and duration is 5m0s
        rides.add(rideBuilder.getRide());

        rideBuilder.createNewRide("18");
        rideBuilder.addRoutePoint("38.018001", "23.730222", "1405678342"); //Thursday, July 18, 2014 1:12:22 PM
        rideBuilder.addRoutePoint("38.019398", "23.728953", "1405678642"); //Distance is 0.1910km and duration is 4m0s
        rides.add(rideBuilder.getRide());

        rideBuilder.createNewRide("19");
        rideBuilder.addRoutePoint("38.018001", "23.730222", "1405595542"); //Thursday, July 17, 2014 2:12:22 PM
        rideBuilder.addRoutePoint("38.019398", "23.728953", "1405595842"); //Distance is 0.1910km and duration is 3m0s
        rides.add(rideBuilder.getRide());

        rideBuilder.createNewRide("20");
        rideBuilder.addRoutePoint("38.018001", "23.730222", "1405681942"); //Thursday, July 18, 2014 2:12:22 PM
        rideBuilder.addRoutePoint("38.019398", "23.728953", "1405682242"); //Distance is 0.1910km and duration is 3m0s
        rides.add(rideBuilder.getRide());
